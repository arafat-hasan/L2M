...
interpretability and fallback precision (RQ2); an explicit
emotion-to-musical-attribute mapping grounds the output well enough to reach
95\% emotion--key consistency (RQ3); a deterministic
music-theory-grounded fallback converts a 15\% LLM failure rate into a 100\%
system completion rate at an acceptable quality cost (RQ4); and hard
...
reliable output (RQ5). More broadly, the results suggest that zero-shot LLM
