...
% ---------------------------------------------------------------
% 1.3 Related Work (merged into Introduction)
% ---------------------------------------------------------------
\subsection{Related Work}

\subsubsection{Generative Models for Music Composition}
...
\subsubsection{Lyrics-to-Melody Generation}
...
\subsubsection{Text-to-Music and Broader Multimodal Generation}
...
This work makes the following contributions to the field of LLM-based music
generation research:
